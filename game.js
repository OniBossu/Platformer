  ...
  for (var y = 0; y < this.height; y++) {
    ...
    for (var x = 0; x < this.width; x++) {
	  ...
	  // Because there is a third case (space ' '), use an "else if" instead of "else"
		...
		fieldType = "arrow-right";
	  else if (ch == "<")
		fieldType = "arrow-left";
...
function ArrowRight(pos, ch) {
	this.pos = pos;
	this.size = new Vector(1, 1);
}
ArrowRight.prototype.type = "arrow-right";

function ArrowLeft(pos, ch) {
	this.pos = pos;
	this.size = new Vector(1, 1);
}
ArrowLeft.prototype.type = "arrow-left";
...
Level.prototype.playerTouched = function(type, actor) {
  ...
  if (type == "lava" && this.status == null) {
    this.status = "lost";
    this.finishDelay = 1;
  } else if (type == "arrow-right" && this.status == null) {
	this.status = "lost";
	this.finishDelay = 1;
  } else if (type == "arrow-left" && this.status == null) {
	this.status = "lost";
	this.finishDelay = 1;
  } else if (type == "coin") {
